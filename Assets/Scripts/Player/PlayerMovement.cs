...
public class PlayerMovement : MonoBehaviour
{
    ...
    //getters and setters
    public int LookingRight { get => lookingRight; private set => lookingRight = value; }
    ...
    private void UpdateAnimation()
    {
        ...
        if (dirX > 0f)
        {
            ...
            LookingRight = 1;
            //TODO: eu realmente tenho que implementar o spawn point do tiro aqui? Não tem como eu pegar por outra classe?
        }
        else if (dirX < 0f)
        {
            state = MovementState.running;
